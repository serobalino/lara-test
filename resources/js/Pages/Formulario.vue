<template>
    <div>
        ...
        <AuthenticatedLayout>
            <template #header>
                <h2 class="font-semibold text-xl text-gray-800 leading-tight">Firma</h2>
            </template>
                ...
                <div class="container mx-auto mt-10 w-3/4">
                    <div class="jumbotron">
                        ...
                        <div class="flex justify-center">
                            <div class="shadow-lg m-5 p-5 rounded-lg sm:w-full w-20 bg-white">
                                <div class="">
                                    <Form @submit="validar" :validation-schema="schema" v-slot="{ errors }">
                                        <fieldset :disabled="cargando">
                                            ...
                                            <label class="block">
                                                Correo Electónico
                                                <Field type="email" v-model="formulario.email" disabled name="email" class="mt-1 block w-full rounded-md bg-gray-100 border-transparent focus:border-gray-500 focus:bg-white focus:ring-0" placeholder="crosales@google.com"/>
                                            </label>
                                            <label class="block">
...
import { Head } from '@inertiajs/inertia-vue3';
    ...
    export default {
        ...
        mounted() {
            this.formulario.email = this.auth.user.email.toLowerCase()
            this.cargarEmpresas();
        }
    }
</script>
